...
export  const NoResults = ()=> {
  return (
   <> <Box display="flex" justifyContent="center">
        {window.location.pathname === '/search'&&<h2 class="no-photos search">Sorry! No results were found</h2>}
        {window.location.pathname === '/favorites'&&<h2 class="no-photos">Sorry, no favorite photos yet!</h2>}
        </Box>
